...
*   иногда картинки добавляются не в конец списка
*   распараллелить получение локации
*   добавить кнопку быстрого скролла вверх
*   добавить удаление заметок по свайпу
*   сделать отмену удаления в списке
*   добавить возможность удаления картинки в самой заметке (примерно как настройки картинки на главном экране)
