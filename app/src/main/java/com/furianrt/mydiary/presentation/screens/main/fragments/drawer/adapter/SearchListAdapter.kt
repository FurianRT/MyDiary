...
import com.furianrt.mydiary.presentation.screens.main.fragments.drawer.adapter.SearchListAdapter.SearchChildViewHolder
import com.furianrt.mydiary.presentation.screens.main.fragments.drawer.adapter.SearchListAdapter.SearchGroupViewHolder
import com.furianrt.mydiary.utils.*
import com.furianrt.mydiary.presentation.views.CalendarDayView
...
class SearchListAdapter(
    ...
    inner class SearchNoCategoryViewHolder(view: View) : SearchChildViewHolder(view) {
        override fun bind(item: SearchItem) {
            ...
            itemView.text_category_count.text = item.count.toString()
            itemView.view_category_color.setBackgroundColor(itemView.context.getColorCompat(R.color.transparent))
        }
